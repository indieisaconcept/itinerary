...
var processor = function (/* Object */ manifest, /* Object */ options) {
    ...
    return function (/* String */ route) {
        ...
        tplKeys.forEach(function (key) {
            ...
            result.templates[key] = util.isRegExp(item) && item.test(route.pathname) ||
        ...
        result.config = config.reduce(function (previous, current) {
             ...
             Object.keys(helpers).forEach(function (key) {
                ...
                if (current) {
                    util._.deepSet(current, key, helpers[key](route, value, result.templates, manifest));
                }
